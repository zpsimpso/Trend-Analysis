#evaluate predictive MSE of a loess fit
#IRW EDITION
...
#perform k-fold CV (e.g., 10 x 10), fitting a LOESS model, returning the optimal f (median of all iterations)
customfitSPAN <- function(kfolds, iterations) {
  y<-numeric(length(iterations))
  for (i in 1:iterations) {
    fitspecial.wrp <- loess.wrapperMSE(FUNlnQ,FUNlnC,folds=kfolds, iteration = i)
...
#perform k-fold CV (e.g., 10 x 10), fitting a LOESS model, returning the estimated MSE of the optimal f
customfitMSE <- function(kfolds, iterations) {
  y<-numeric(length(iterations))
  for (i in 1:iterations) {
    fitspecial.wrp <- loess.wrapperMSE(FUNlnQ,FUNlnC,folds=kfolds, iteration = i)
    iter <- fitspecial.wrp$MSE
    y[i]<-iter
    print(i)
  }
  median_MSE<-median(y)
...
customfitMSEall <- function(kfolds, iterations) {
...
#evaluate prediction error for one loess fit (ie one span value) via kfold CV
crossval_loess <- function(x, y, span, folds, iterations){
  mse <- numeric(length=iterations)
  theta.fit <- function(x, y, span) loess(y~x, span=span)
  theta.predict <- function(fit, x0) predict(fit, newdata=x0)
  ii = 0
  for (i in 1:iterations){
...
#####################################################
setwd("F:/TRENDS/IRW TRENDS/IRW/Baron_Fork/")
getwd()
SITE<-'BARON'
...
NO3span <- customfitSPAN(10, 10)

NO3_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=NO3span, folds = 10, iterations = 10)
NO3_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
TNspan <- customfitSPAN(10, 10)

TN_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=TNspan, folds = 10, iterations = 10)
TN_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
SRPspan <- customfitSPAN(10, 10)

SRP_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=SRPspan, folds = 10, iterations = 10)
SRP_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
TPspan <- customfitSPAN(10, 10)

TP_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=TPspan, folds = 10, iterations = 10)
TP_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
TSSspan <- customfitSPAN(10, 10)

TSS_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=TSSspan, folds = 10, iterations = 10)
TSS_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
Clspan <- customfitSPAN(10, 10)

Cl_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=Clspan, folds = 10, iterations = 10)
Cl_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
SO4span <- customfitSPAN(10, 10)

SO4_optmse <- crossval_loess(FUNlnQ, FUNlnC, span=SO4span, folds = 10, iterations = 10)
SO4_05mse <- crossval_loess(FUNlnQ, FUNlnC, span = 0.5, folds = 10, iterations = 10)
...
colnames(df) <- c('Site', 'Const', 'Opt_MSE', 'f05_MSE')
df[1:7,1]<-SITE
...
write.csv(df, "MSE_customfit.csv")
###################################################################
##################################################################
###################################################################
setwd("F:/TRENDS/IRW TRENDS/IRW/FC12/")
getwd()
SITE<-'FC12'
...
##################################################################
###################################################################
setwd("F:/TRENDS/IRW TRENDS/IRW/FCWSS/")
getwd()
SITE<-'FCWSS'
...
##################################################################
###################################################################
setwd("F:/TRENDS/IRW TRENDS/IRW/Sager/")
getwd()
SITE<-'Sager'
...
##################################################################
###################################################################
setwd("F:/TRENDS/IRW TRENDS/IRW/Savoy/")
getwd()
SITE<-'Savoy'
